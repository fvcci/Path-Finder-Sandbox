...
export default {
  ...
  theme: {
  	...
  	animation: {
  		...
  		'visited-node-appear': 'visited-node-appear 2s ease 0s 1 normal forwards running',
  		'visited-node-vanish': 'visited-node-vanish 1.5s ease 0s 1 normal forwards running',
  		'shortest-path-node-appear': 'shortest-path-node-appear 1.5s ease 0s 1 normal forwards running',
  		'shortest-path-node-vanish': 'shortest-path-node-vanish 1.5s ease 0s 1 normal forwards running',
  		'destination-node': 'destination-node 0.3s ease 0s 1 normal forwards running'
  	}
  },
